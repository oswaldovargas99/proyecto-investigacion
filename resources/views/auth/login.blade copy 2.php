...
<x-guest-layout>
    {{-- TOASTS opcionales: <x-toast /> --}}

    <div class="relative min-h-screen w-full overflow-hidden" x-data="{ show:false, privacy:false }" x-init="setTimeout(() => show = true, 100)">
            ...
            <div class="w-full max-w-md">
                <div x-bind:class="show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'"
                    ...
                    <div class="flex flex-col items-center gap-3 border-b border-slate-200/70 px-6 py-6 text-center">
                        <img src="{{ asset('images/login/logo_cgipv01.png') }}" alt="Logo SGIPFP"
                             class="h-12 w-12 rounded-full object-contain shadow-sm" />
                        <div>
                            <h1 class="text-lg font-semibold text-slate-800">Programa de Fortalecimiento del Posgrado (PFP)</h1>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-6 space-y-4">
                        ...
                        @if ($errors->any())
                            <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show"
                                 ...
                                 class="mb-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700" role="alert">
                ...
                {{-- Pie: marca + Aviso de Privacidad (abre modal) --}}
                <div class="mt-6 text-center text-xs text-white/90 space-y-1">
        ...
        <div  x-cloak
            ...
            {{-- Backdrop --}}
            <div class="absolute inset-0 bg-black/50 backdrop-blur-[2px]" @click="privacy = false" aria-hidden="true"></div>
            ...
            <div id="privacy-modal" role="dialog" aria-modal="true" aria-labelledby="privacy-title"
                ...
                <div class="flex items-center justify-end gap-2 border-t border-slate-200 px-5 py-3">
                    {{-- Enlace a la versión completa (opcional si mantienes la ruta pública) --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setImage(i);
            setInterval(() => { i = (i + 1) % wallpapers.length; setImage(i); }, 10000);
        });
    </script>
</x-guest-layout>
