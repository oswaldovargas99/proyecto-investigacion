...
<?php $component->withAttributes([]); ?>
    ...
    <div class="relative min-h-screen w-full overflow-hidden"
        ...
        <div id="wallpaper"
             ...
             style="background-image:url('<?php echo e(asset('images/login/cgipv04.jpg')); ?>')"></div>
            ...
            <div x-data="{ show:true }" x-init="setTimeout(()=> show=false, 6000)" x-show="show" x-cloak x-transition
                ...
                <div class="flex items-start gap-3 rounded-lg bg-amber-600 text-white px-4 py-3 shadow-lg ring-1 ring-amber-500/40">
                    ...
                    <div class="text-sm/5">
                        ...
                        <div>Revisa los campos marcados (<?php echo e($errors->count()); ?>).</div>
                    </div>
                    <button class="ms-auto opacity-80 hover:opacity-100" @click="show=false" aria-label="Cerrar">
                        ✕
                    </button>
            ...
            <div class="w-full max-w-md">
                ...
                <div x-bind:class="show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'"
                    ...
                    <div class="flex flex-col items-center gap-4 px-6 pt-8 pb-2 text-center">
                        <img id="login-logo" src="<?php echo e(asset('images/login/logo_cgipv01.png')); ?>" alt="Logo CGIPV"
                    ...
                    <div class="px-6 pt-3 pb-6 space-y-4">
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-3.5" novalidate>
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" required autofocus
                                           class="w-full rounded-lg pl-9 pr-3 py-2.5 border <?php $__errorArgs = ['email'];
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="relative" x-data="{ visible:false }">
                                    ...
                                    <input id="password" name="password" :type="visible ? 'text' : 'password'" required
                                           class="w-full rounded-lg pl-9 pr-10 py-2.5 border <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-slate-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4 text-center text-[11px] text-white/90">
                    Universidad de Guadalajara · CGIPV · <?php echo e(now()->year); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/auth/login.blade.php ENDPATH**/ ?>