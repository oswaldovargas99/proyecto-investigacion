        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input
                    ...
                    name="nombre_rector"
                    id="nombre_rector"
                    value="<?php echo e(old('nombre_rector', $centro->nombre_rector ?? '')); ?>"
                    required
            ...
            <div>
                ...
                <select
                    ...
                    <option value="Centro Universitario Metropolitano"
                        <?php echo e(old('tipo_centro_universitario', $centro->tipo_centro_universitario ?? '') === 'Centro Universitario Metropolitano' ? 'selected' : ''); ?>>
                        Centro Universitario Metropolitano
                    </option>
                    <option value="Centro Universitario Regional"
                        <?php echo e(old('tipo_centro_universitario', $centro->tipo_centro_universitario ?? '') === 'Centro Universitario Regional' ? 'selected' : ''); ?>>
                        Centro Universitario Regional
                    </option>
                </select>
                <p class="text-xs text-gray-500 mt-1">Clasificación administrativa.</p>
                <?php $__errorArgs = ['tipo_centro_universitario'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-600 text-sm mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-1">
                ...
                <input
                    ...
                    value="<?php echo e(old('centro_universitario', $centro->centro_universitario ?? '')); ?>"
                    required
                    placeholder="Ej. Centro Universitario de la Costa"
                    class="mt-1 w-full rounded-lg border-gray-300 px-3 py-2
                           focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                <?php $__errorArgs = ['centro_universitario'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-600 text-sm mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="siglas"
                    id="siglas"
                    value="<?php echo e(old('siglas', $centro->siglas ?? '')); ?>"
                    required
                    maxlength="50"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="telefonos"
                    id="telefonos"
                    value="<?php echo e(old('telefonos', $centro->telefonos ?? '')); ?>"
                    required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="sitio_web"
                    id="sitio_web"
                    value="<?php echo e(old('sitio_web', $centro->sitio_web ?? '')); ?>"
                    placeholder="https://ejemplo.udg.mx"
                    class="mt-1 w-full rounded-lg border-gray-300 px-3 py-2
                           focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                <?php $__errorArgs = ['sitio_web'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-600 text-sm mt-1"><?php echo e($message); ?></p> <?php unset($message);
                ...
                <div class="mt-2">
                    ...
                    <label class="inline-flex items-center cursor-pointer select-none">
                        <input type="checkbox" name="vigente" value="1"
                               <?php echo e(old('vigente', $centro->vigente ?? 1) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="colonia"
                    id="colonia"
                    value="<?php echo e(old('colonia', $centro->colonia ?? '')); ?>"
                    required
                    class="mt-1 w-full rounded-lg border-gray-300 px-3 py-2
                           focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="codigo_postal"
                    id="codigo_postal"
                    value="<?php echo e(old('codigo_postal', $centro->codigo_postal ?? '')); ?>"
                    required
                    class="mt-1 w-full rounded-lg border-gray-300 px-3 py-2
                           focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="municipio"
                    id="municipio"
                    value="<?php echo e(old('municipio', $centro->municipio ?? '')); ?>"
                    required
                    class="mt-1 w-full rounded-lg border-gray-300 px-3 py-2
                           focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="estado"
                    id="estado"
                    value="<?php echo e(old('estado', $centro->estado ?? 'Jalisco')); ?>"
                    readonly
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input
                    ...
                    name="pais"
                    id="pais"
                    value="<?php echo e(old('pais', $centro->pais ?? 'México')); ?>"
                    readonly
                    class="mt-1 w-full rounded-lg border-gray-300 px-3 py-2 bg-gray-100 cursor-not-allowed
                           focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
    ...
    <div class="flex flex-col sm:flex-row gap-3 sm:justify-between sm:items-center">
        ...
        <button type="submit"
            class="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg text-white
                   <?php echo e(isset($centro) ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-green-600 hover:bg-green-700'); ?>">
            ...
            <span><?php echo e(isset($centro) ? 'Actualizar' : 'Guardar'); ?></span>
        </button>
    </div>

</div>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/centros/form.blade.php ENDPATH**/ ?>