<!-- resources/views/administrador/rubros/index.blade.php -->
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-20 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a href="<?php echo e(route('admin.rubros.create')); ?>"
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="mb-4 rounded-xl border bg-white p-4">
                <form method="GET" action="<?php echo e(route('admin.rubros.index')); ?>" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex w-full items-center gap-2 sm:max-w-md">
                        <div class="relative w-full">
                            <input
                                ...
                                name="q"
                                value="<?php echo e($q); ?>"
                                placeholder="Buscar por rubro o concepto…"
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span class="font-semibold"><?php echo e($rubros->firstItem() ?? 0); ?>–<?php echo e($rubros->lastItem() ?? 0); ?></span>
                        <span class="hidden sm:inline">de</span>
                        <span class="font-semibold"><?php echo e($rubros->total()); ?></span>
            ...
            <div class="overflow-x-auto rounded-xl border bg-white">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $rubros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rubro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/80">
                                <td class="px-4 py-3">
                                    <?php echo e($loop->iteration + ($rubros->firstItem() - 1)); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-900"><?php echo e($rubro->concepto); ?></div>
                                </td>

                                <td class="px-4 py-3">
                                    <span class="inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium
                                                bg-gray-100 text-gray-700 ring-1 ring-inset ring-gray-200">
                                        <?php echo e($categoriasMap[$rubro->categoria_id] ?? '—'); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1.5">
                                        <a href="<?php echo e(route('admin.rubros.show', $rubro)); ?>"
                                           title="Ver"
                                        ...
                                        <a href="<?php echo e(route('admin.rubros.edit', $rubro)); ?>"
                                           title="Editar"
                                            ...
                                            <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
                                                ...
                                                <div class="relative w-full max-w-sm rounded-xl bg-white p-5 shadow-lg">
                                                    ...
                                                    <p class="mb-4 text-sm text-gray-600">
                                                        ¿Deseas eliminar el rubro <span class="font-medium"><?php echo e($rubro->rubro); ?></span>?
                                                    </p>
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        <form action="<?php echo e(route('admin.rubros.destroy', $rubro)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
            ...
            <div class="mt-4 flex flex-col items-center justify-between gap-2 sm:flex-row">
                <div class="text-sm text-gray-600">
                    Mostrando
                    <span class="font-semibold"><?php echo e($rubros->firstItem() ?? 0); ?></span>
                    a
                    <span class="font-semibold"><?php echo e($rubros->lastItem() ?? 0); ?></span>
                    de
                    <span class="font-semibold"><?php echo e($rubros->total()); ?></span>
                    registros
                </div>
                <div>
                    <?php echo e($rubros->onEachSide(1)->links('vendor.pagination.pretty')); ?>
...
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/rubros/index.blade.php ENDPATH**/ ?>