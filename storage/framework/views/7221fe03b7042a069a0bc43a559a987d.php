        ...
        <div class="mx-auto max-w-6xl px-4 space-y-6">
            ...
            <div class="flex items-center justify-between rounded-2xl border bg-white px-5 py-4 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-base sm:text-lg font-semibold text-gray-900"><?php echo e($usuario->name); ?></h3>
                        <p class="text-xs text-gray-500">
                            Código:
                            <span class="font-semibold text-indigo-600"><?php echo e($usuario->id); ?></span>
                        </p>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div class="rounded-xl border bg-gray-50 px-4 py-3">
                                ...
                                <p class="mt-1 text-sm text-gray-800">
                                    <a href="mailto:<?php echo e($usuario->email); ?>" class="text-indigo-600 hover:text-indigo-800 underline decoration-dotted underline-offset-2">
                ...
                <section class="rounded-2xl border bg-white p-5 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <div class="rounded-xl border bg-gray-50 px-4 py-3">
                            ...
                            <p class="mt-1 text-sm text-gray-800">
                                <?php echo e(optional($usuario->created_at)->format('d/m/Y H:i') ?? '—'); ?>
                        ...
                        <div class="rounded-xl border bg-gray-50 px-4 py-3">
                            ...
                            <p class="mt-1 text-sm text-gray-800">
                                <?php echo e(optional($usuario->updated_at)->format('d/m/Y H:i') ?? '—'); ?>
                        ...
                        <div class="rounded-xl border bg-gray-50 px-4 py-3">
                            ...
                            <p class="mt-1 text-sm text-gray-800">#<?php echo e($usuario->id); ?></p>
                        </div>
                    </div>
                </section>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/usuarios/show.blade.php ENDPATH**/ ?>