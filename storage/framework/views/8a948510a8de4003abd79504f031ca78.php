...
<nav class="relative"
        ...
        <div class="h-full px-4 sm:px-6 flex items-center justify-end gap-3">
            <div class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white/80 px-3 py-2 shadow-sm">
                <!--[if BLOCK]><![endif]--><?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                    <img class="size-9 rounded-full object-cover" src="<?php echo e($u->profile_photo_url); ?>" alt="<?php echo e($userLabel); ?>">
                <?php else: ?>
                ...
                <div class="min-w-0">
                    <p class="truncate text-sm font-semibold text-gray-800 leading-5"><?php echo e($userLabel); ?></p>
                    <p class="truncate text-xs text-gray-500"><?php echo e($userEmail); ?></p>
                </div>
    ...
    <aside class="fixed inset-y-0 left-0 z-40 flex flex-col transition-[width] duration-200
        ...
        <div class="relative flex items-center h-20 border-b border-gray-100 px-3">
            <a href="https://vicerrectoriaacademica.udg.mx/" target="_blank"
               class="flex-1 inline-flex items-center gap-3">
                <img src="<?php echo e(asset('storage/images/logo_cgipv02.png')); ?>" alt="CGIPV"
        ...
        <nav class="px-2 py-4 text-sm flex-1 overflow-y-auto">
            ...
            <div class="mb-6">
                <?php echo $section('General'); ?>

                <ul class="space-y-1.5">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>"
                           :title="open ? '' : 'Inicio'"
                           class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('dashboard') || request()->routeIs('dashboard.*') ? $active : $inactive); ?>">
                            <svg class="h-5 w-5 <?php echo e(request()->routeIs('dashboard') || request()->routeIs('dashboard.*') ? $iconAc : $iconIn); ?>"
            ...
            <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                <!--[if BLOCK]><![endif]--><?php if($role === 1): ?>
                    
                    <div class="mb-6">
                        <?php echo $section('Módulos'); ?>

                        <ul class="space-y-1.5">
                            
                            <li>
                                <a href="<?php echo e(route('usuario.datos-generales.create')); ?>"
                                   :title="open ? '' : 'Datos Generales'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('usuario.datos-generales.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('usuario.datos-generales.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <li>
                                <a href="<?php echo e(route('usuario.solicitud.create')); ?>"
                                   :title="open ? '' : 'Solicitud'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('usuario.solicitud.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('usuario.solicitud.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <li>
                                <a href="<?php echo e(route('usuario.rubros-solicitados.create')); ?>"
                                   :title="open ? '' : 'Rubros Solicitados'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('usuario.rubros-solicitados.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('usuario.rubros-solicitados.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                            ...
                            <li>
                                <a href="<?php echo e(route('usuario.documentaciones.create')); ?>"
                                   :title="open ? '' : 'Documentación'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('usuario.documentaciones.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('usuario.documentaciones.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <li>
                                <a href="<?php echo e(route('usuario.informes.index')); ?>"
                                   :title="open ? '' : 'Informes'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('usuario.informes.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('usuario.informes.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <!--[if BLOCK]><![endif]--><?php if($role === 3): ?>
                    
                    <div class="mb-6">
                        <?php echo $section('Catálogos'); ?>

                        <ul class="space-y-1.5">
                            <li>
                                <a href="<?php echo e(route('admin.centros.index')); ?>"
                                   :title="open ? '' : 'Centros Universitarios'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.centros.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.centros.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.posgrados.index')); ?>"
                                   ...
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.posgrados.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.posgrados.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.rubros-categorias.index')); ?>"
                                   ...
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.rubros-categorias.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.rubros-categorias.*') ? $iconAc : $iconIn); ?>"
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.rubros.index')); ?>"
                                   :title="open ? '' : 'Rubros'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.rubros.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.rubros.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.coordinadores.index')); ?>"
                                   ...
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.coordinadores.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.coordinadores.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.usuarios.index')); ?>"
                                   :title="open ? '' : 'Usuarios'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.usuarios.*') ? $active : $inactive); ?>">
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.usuarios.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 21a8 8 0 0 1 16 0"/>
                                    </svg>
                    ...
                    <div class="mb-6">
                        <?php echo $section('Convocatorias'); ?>

                        <ul class="space-y-1.5">
                            <li>
                                <a href="<?php echo e(route('admin.convocatorias.index')); ?>"
                                   :title="open ? '' : 'Convocatorias'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.convocatorias.*') ? $active : $inactive); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         class="h-5 w-5 <?php echo e(request()->routeIs('admin.convocatorias.*') ? $iconAc : $iconIn); ?>"
                    ...
                    <div class="mb-6">
                        <?php echo $section('Administración'); ?>

                        <ul class="space-y-1.5">
                            
                            <li>
                                <a href="<?php echo e($hasAdminSolicitudes ? route('admin.solicitudes.index') : 'javascript:void(0)'); ?>"
                                   :title="open ? '' : 'Solicitudes'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.solicitudes.*') ? $active : $inactive); ?>"
                                   <?php if(!$hasAdminSolicitudes): ?> title="Próximamente" aria-disabled="true" <?php endif; ?>>
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.solicitudes.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                              d="M4 4h12a2 2 0 0 1 2 2v12l-4-3H6a2 2 0 0 1-2-2V4Z"/>
                                    </svg>
                                    <span class="truncate" x-show="open">Solicitudes</span>
                                    <!--[if BLOCK]><![endif]--><?php if (! ($hasAdminSolicitudes)): ?>
                            ...
                            <li>
                                <a href="<?php echo e($hasAdminInformes ? route('admin.informes.index') : 'javascript:void(0)'); ?>"
                                   :title="open ? '' : 'Informes'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.informes.*') ? $active : $inactive); ?>"
                                   <?php if(!$hasAdminInformes): ?> title="Próximamente" aria-disabled="true" <?php endif; ?>>
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.informes.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                              d="M4 5h16M8 9h12M8 13h12M8 17h8M4 9h2M4 13h2M4 17h2"/>
                                    </svg>
                                    <span class="truncate" x-show="open">Informes</span>
                                    <!--[if BLOCK]><![endif]--><?php if (! ($hasAdminInformes)): ?>
                                        <span class="ml-auto text-[10px] rounded bg-slate-100 px-1.5 py-0.5 text-slate-500">Soon</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="<?php echo e($hasAdminStats ? route('admin.estadistica.index') : 'javascript:void(0)'); ?>"
                                   :title="open ? '' : 'Estadística'"
                                   class="<?php echo e($baseLi); ?> <?php echo e(request()->routeIs('admin.estadistica.*') ? $active : $inactive); ?>"
                                   <?php if(!$hasAdminStats): ?> title="Próximamente" aria-disabled="true" <?php endif; ?>>
                                    <svg class="h-5 w-5 <?php echo e(request()->routeIs('admin.estadistica.*') ? $iconAc : $iconIn); ?>"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                              d="M4 20V4M20 20H4M7 16v-3m4 3V8m4 8v-5"/>
                                    </svg>
                                    <span class="truncate" x-show="open">Estadística</span>
                                    <!--[if BLOCK]><![endif]--><?php if (! ($hasAdminStats)): ?>
                                        <span class="ml-auto text-[10px] rounded bg-slate-100 px-1.5 py-0.5 text-slate-500">Soon</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </a>
                            </li>
        ...
        <div class="shrink-0 border-t border-gray-100 bg-white px-3 py-3 text-[11px] text-slate-500">
            <p class="text-center">CGIPV © <?php echo e(now()->year); ?> Universidad de Guadalajara.</p>
        </div>
    </aside>
</nav>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/navigation-menu.blade.php ENDPATH**/ ?>