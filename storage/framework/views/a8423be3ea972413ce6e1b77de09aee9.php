...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto bg-white p-6 rounded shadow">
            ...
            <form action="<?php echo e(route('usuario.datos-generales.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/usuario/datos-generales/create.blade.php ENDPATH**/ ?>