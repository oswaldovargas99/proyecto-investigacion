            ...
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <h3 class="text-lg font-semibold text-gray-800 truncate">
                        <?php echo e($solicitud->nombre_coordinador); ?>

                    </h3>
                    <p class="text-sm text-gray-500">
                        Código: <span class="font-medium text-gray-700"><?php echo e($solicitud->codigo); ?></span>
                    </p>
                </div>

                <div class="ms-auto flex items-center gap-2">
                    <a href="<?php echo e(route('admin.solicitudes.pdf', $solicitud->id)); ?>"
                       target="_blank"
            ...
            <section class="bg-white rounded-2xl shadow-sm border p-6">
                ...
                <dl class="space-y-3">
                    <div class="flex justify-between gap-4">
                        ...
                        <dd class="text-sm text-gray-800"><?php echo e($solicitud->centro_universitario); ?></dd>
                    </div>

                    <div class="flex justify-between gap-4">
                        <dt class="text-sm text-gray-500">Nivel de estudios</dt>
                        <dd class="text-sm text-gray-800"><?php echo e($solicitud->nivel_estudios); ?></dd>
                    </div>

                    <div class="flex justify-between gap-4">
                        <dt class="text-sm text-gray-500">Posgrado</dt>
                        <dd class="text-sm text-gray-800"><?php echo e($solicitud->nombre_posgrado); ?></dd>
                    </div>

                    <div class="flex justify-between gap-4">
                        <dt class="text-sm text-gray-500">Clave SNP</dt>
                        <dd class="text-sm text-gray-800"><?php echo e($solicitud->clave_snp); ?></dd>
                    </div>
                </dl>
            </section>
            ...
            <section class="bg-white rounded-2xl shadow-sm border p-6 lg:col-span-2">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="p-4 rounded-xl bg-gray-50 border">
                        ...
                        <dd class="mt-1 text-sm text-gray-800">
                            <?php echo e($solicitud->modalidad ?? '—'); ?>
                    ...
                    <div class="p-4 rounded-xl bg-gray-50 border md:col-span-2">
                        ...
                        <dd class="mt-1 text-sm text-gray-800">
                            <?php echo e($solicitud->justificacion ?? '—'); ?>
                ...
                <div class="overflow-x-auto rounded-xl border">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $total = 0; ?>
                            <?php $__currentLoopData = $rubros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $total += $r->monto_solicitado; ?>
                                <tr class="hover:bg-gray-50/80">
                                    <td class="px-4 py-3"><?php echo e($r->rubro_nombre); ?></td>
                                    <td class="px-4 py-3"><?php echo e($r->descripcion); ?></td>
                                    <td class="px-4 py-3 text-right">$<?php echo e(number_format($r->monto_solicitado, 2)); ?></td>
                                </tr>
                        ...
                        <tfoot class="bg-gray-50 font-semibold">
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right text-green-700">$<?php echo e(number_format($total, 2)); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/solicitudes/show.blade.php ENDPATH**/ ?>