...
<div class="mx-auto max-w-6xl px-4 py-8">
    ...
    <form method="POST"
          action="<?php echo e(route('usuario.rubros-solicitados.rubros.save', $registroId)); ?>"
          x-data="rubrosForm({
              rubros: <?php echo \Illuminate\Support\Js::from($rubros)->toHtml() ?>,
              categorias: <?php echo \Illuminate\Support\Js::from($categorias)->toHtml() ?>,
              montoAsignado: <?php echo e(number_format($montoAsignado, 2, '.', '')); ?>,
              prevRubros: <?php echo \Illuminate\Support\Js::from($rubrosMontosPrev)->toHtml() ?>,
              totalOtrosBD: <?php echo e((float) $totalOtrosBD); ?>
    ...
    <form method="POST"
          action="<?php echo e(route('usuario.rubros-solicitados.otros.save', $registroId)); ?>"
          x-data="otrosForm({
              montoAsignado: <?php echo e(number_format($montoAsignado, 2, '.', '')); ?>,
              prevOtros: <?php echo \Illuminate\Support\Js::from($otrosRubrosPrev)->toHtml() ?>,
              totalRubrosBD: <?php echo e((float) $totalRubrosBD); ?>
...
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/usuario/rubros-solicitados/form.blade.php ENDPATH**/ ?>