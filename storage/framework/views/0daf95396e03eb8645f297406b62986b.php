    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto px-4">
            <div class="bg-white rounded-2xl border shadow-sm p-6">
                <form action="<?php echo e(route('admin.posgrados.store')); ?>" method="POST" novalidate>
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/posgrados/create.blade.php ENDPATH**/ ?>