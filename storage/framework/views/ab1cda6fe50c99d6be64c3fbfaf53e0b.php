<!-- resources/views/administrador/rubros-categorias/index.blade.php -->
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-20 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <h2 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
            ...
            Gestión de Categorías de Rubros
        </h2>

        <a href="<?php echo e(route('admin.rubros-categorias.create')); ?>"
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="mb-4 rounded-xl border bg-white p-4">
                <form method="GET" action="<?php echo e(route('admin.rubros-categorias.index')); ?>"
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span class="font-semibold"><?php echo e($categorias->firstItem() ?? 0); ?>–<?php echo e($categorias->lastItem() ?? 0); ?></span>
                        <span class="hidden sm:inline">de</span>
                        <span class="font-semibold"><?php echo e($categorias->total()); ?></span>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/80">
                                <td class="px-4 py-3">
                                    <?php echo e($loop->iteration + ($categorias->firstItem() - 1)); ?>

                                </td>

                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-900"><?php echo e($c->categoria); ?></div>
                                </td>

                                <td class="px-4 py-3">
                                    <div class="text-gray-700">
                                        <?php echo e(\Illuminate\Support\Str::limit($c->descripcion, 120) ?: '—'); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1.5">
                                        <a href="<?php echo e(route('admin.rubros-categorias.show', $c)); ?>"
                                           title="Ver"
                                           class="inline-flex items-center gap-1 rounded-md border border-gray-200 bg-white px-2 py-1 text-xs text-gray-700 hover:bg-gray-50">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 6C7 6 2.73 9.11 1 14c1.73 4.89 6 8 11 8s9.27-3.11 11-8c-1.73-4.89-6-8-11-8zm0 13a5 5 0 1 1 .001-10.001A5 5 0 0 1 12 19zm0-8a3 3 0 1 0 .001 6.001A3 3 0 0 0 12 11z"/>
                                            </svg>
                                            Ver
                                        </a>

                                        <a href="<?php echo e(route('admin.rubros-categorias.edit', $c)); ?>"
                                           title="Editar"
                                                ...
                                                <div class="relative w-full max-w-sm rounded-xl bg-white p-5 shadow-lg">
                                                    <div class="mb-3 flex items-center gap-2">
                                                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-red-100 text-red-600">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                                                                <path d="M11 7h2v8h-2zm0 10h2v2h-2z"/><path d="M12 2a10 10 0 1 0 .001 20.001A10 10 0 0 0 12 2z"/>
                                                            </svg>
                                                        </div>
                                                        <h3 class="text-sm font-semibold text-gray-800">Confirmar eliminación</h3>
                                                    </div>
                                                    <p class="mb-4 text-sm text-gray-600">
                                                        ¿Deseas eliminar la categoría <span class="font-medium"><?php echo e($c->categoria); ?></span>?
                                                    </p>
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        <form action="<?php echo e(route('admin.rubros-categorias.destroy', $c)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                ...
                                <td colspan="4" class="px-4 py-10 text-center text-sm text-gray-500">
                                    <div class="mx-auto mb-2 h-10 w-10 rounded-full bg-gray-100 text-gray-400 flex items-center justify-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M19 3H4.99C3.88 3 3 3.89 3 5l-.01 14c0 1.1.89 2 2 2H19c1.1 0 1.99-.9 1.99-2L21 5c0-1.11-.89-2-2-2zm0 14h-4.3c-.39 0-.75.23-.92.59l-.57 1.15H10.8l-.58-1.16c-.17-.35-.53-.58-.92-.58H5V5h14v12z"/>
                                        </svg>
                                    </div>
            ...
            <div class="mt-4 flex flex-col items-center justify-between gap-2 sm:flex-row">
                <div class="text-sm text-gray-600">
                    Mostrando
                    <span class="font-semibold"><?php echo e($categorias->firstItem() ?? 0); ?></span>
                    a
                    <span class="font-semibold"><?php echo e($categorias->lastItem() ?? 0); ?></span>
                    de
                    <span class="font-semibold"><?php echo e($categorias->total()); ?></span>
                    registros
                </div>
                <div>
                    <?php echo e($categorias->onEachSide(1)->links('vendor.pagination.pretty')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/rubros-categorias/index.blade.php ENDPATH**/ ?>