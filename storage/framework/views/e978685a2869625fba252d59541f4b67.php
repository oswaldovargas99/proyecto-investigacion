<!-- resources/views/administrador/coordinadores/index.blade.php -->
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-20 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <h2 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
            ...
            Gestión de Coordinadores de Posgrados
        </h2>

        <a href="<?php echo e(route('admin.coordinadores.create')); ?>"
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="mb-4 rounded-xl border bg-white p-4">
                <form method="GET" action="<?php echo e(route('admin.coordinadores.index')); ?>" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex w-full items-center gap-2 sm:max-w-md">
                        <div class="relative w-full">
                            <input
                                ...
                                name="q"
                                value="<?php echo e($q); ?>"
                                placeholder="Buscar por nombre, código, correo, centro, posgrado…"
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span class="font-semibold"><?php echo e($coordinadores->firstItem() ?? 0); ?>–<?php echo e($coordinadores->lastItem() ?? 0); ?></span>
                        <span class="hidden sm:inline">de</span>
                        <span class="font-semibold"><?php echo e($coordinadores->total()); ?></span>
                ...
                <table class="min-w-full text-sm">
                    <thead class="sticky top-0 z-10 bg-gray-50/80 backdrop-blur">
                        <tr class="text-left text-gray-700">
                            ...
                            <th class="px-4 py-3 font-semibold">Correo inst.</th>
                            <th class="px-4 py-3 font-semibold">Teléfono</th>
                            <th class="px-4 py-3 text-center font-semibold">Acciones</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $coordinadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coordinador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/80">
                                <td class="px-4 py-3">
                                    <?php echo e($loop->iteration + ($coordinadores->firstItem() - 1)); ?>
                                ...
                                <td class="px-4 py-3">
                                    <span class="inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium
                                        ...
                                        <?php echo e($coordinador->codigo); ?>

                                    </span>
                                </td>

                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-900"><?php echo e($coordinador->nombre_coordinador); ?></div>
                                    <div class="text-xs text-gray-500">
                                        <?php echo e(optional($coordinador->genero)->genero); ?> · <?php echo e(optional($coordinador->nivelEstudios)->nivel_estudios); ?>

                                    </div>
                                </td>
                                <td class="px-4 py-3">
                                    <?php echo e(optional($coordinador->centro)->centro_universitario ?? '—'); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <?php echo e(optional($coordinador->posgrado)->nombre_posgrado ?? '—'); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <a href="mailto:<?php echo e($coordinador->correo_institucional); ?>"
                                       class="text-indigo-600 hover:text-indigo-800 underline decoration-dotted underline-offset-2">
                                        <?php echo e($coordinador->correo_institucional); ?>

                                    </a>
                                </td>
                                <td class="px-4 py-3">
                                    <span><?php echo e($coordinador->telefono ?: '—'); ?></span>
                                    <?php if($coordinador->extension): ?>
                                        <span class="text-gray-500"> · ext. <?php echo e($coordinador->extension); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1.5">
                                        <a href="<?php echo e(route('admin.coordinadores.show', $coordinador)); ?>"
                                           title="Ver"
                                        ...
                                        <a href="<?php echo e(route('admin.coordinadores.edit', $coordinador)); ?>"
                                           title="Editar"
                                            ...
                                            <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
                                                ...
                                                <div class="relative w-full max-w-sm rounded-xl bg-white p-5 shadow-lg">
                                                    ...
                                                    <p class="mb-4 text-sm text-gray-600">
                                                        ¿Deseas eliminar al coordinador <span class="font-medium"><?php echo e($coordinador->nombre_coordinador); ?></span>?
                                                    </p>
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        <form action="<?php echo e(route('admin.coordinadores.destroy', $coordinador)); ?>"
                                                              method="POST">
                                                            <?php echo csrf_field(); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="8" class="px-4 py-10 text-center text-sm text-gray-500">
                                    ...
                                    No hay coordinadores que coincidan con tu búsqueda.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
            ...
            <div class="mt-4 flex flex-col items-center justify-between gap-2 sm:flex-row">
                <div class="text-sm text-gray-600">
                    Mostrando
                    <span class="font-semibold"><?php echo e($coordinadores->firstItem() ?? 0); ?></span>
                    a
                    <span class="font-semibold"><?php echo e($coordinadores->lastItem() ?? 0); ?></span>
                    de
                    <span class="font-semibold"><?php echo e($coordinadores->total()); ?></span>
                    registros
                </div>
                <div>
                    <?php echo e($coordinadores->onEachSide(1)->links('vendor.pagination.pretty')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/coordinadores/index.blade.php ENDPATH**/ ?>