...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <span class="inline-flex items-center gap-1 rounded-full bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-700 ring-1 ring-inset ring-gray-200">
                        Total: <strong class="text-gray-900"><?php echo e($solicitudes->total()); ?></strong>
                    </span>
                    <span class="inline-flex items-center gap-1 rounded-full bg-indigo-50 px-3 py-1.5 text-xs font-medium text-indigo-700 ring-1 ring-inset ring-indigo-200">
                        Mostrando:
                        <strong><?php echo e($solicitudes->firstItem() ?? 0); ?>–<?php echo e($solicitudes->lastItem() ?? 0); ?></strong>
                    </span>
                    <?php if(!empty($q)): ?>
        ...
        <section class="mb-4 rounded-2xl border border-gray-200 bg-white p-4 sm:p-5">
            <form method="GET" action="<?php echo e(route('admin.solicitudes.index')); ?>"
                ...
                <div class="sm:col-span-3">
                    <select name="estado"
                        ...
                        <option value="revisado"  <?php echo e(request('estado')==='revisado'  ? 'selected' : ''); ?>>Revisado</option>
                        <option value="validado"  <?php echo e(request('estado')==='validado'  ? 'selected' : ''); ?>>Validado</option>
                    </select>
                </div>
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div>
                                <h3 class="text-base font-semibold text-gray-900">
                                    <?php echo e($s->nombre_posgrado); ?>

                                </h3>
                                <p class="mt-0.5 text-sm text-gray-600">
                                    <span class="font-medium"><?php echo e($s->centro_universitario); ?></span>
                                    <span class="mx-1 text-gray-300">•</span>
                                    Nivel: <?php echo e($s->nivel_estudios); ?>

                                </p>
                                <p class="mt-1 text-sm text-gray-600">
                                    Coord.: <span class="font-medium text-gray-800"><?php echo e($s->nombre_coordinador); ?></span>
                                </p>
                                <div class="mt-2 flex flex-wrap items-center gap-1.5">
                                    ...
                                    <span class="inline-flex items-center rounded-md px-2 py-0.5 text-[11px] font-medium bg-slate-50 text-slate-700 ring-1 ring-inset ring-slate-200">
                                        SNP: <?php echo e($s->clave_snp); ?>

                                    </span>
                                    <?php if(isset($s->estado)): ?>
                            ...
                            <div class="text-right">
                                ...
                                <div class="text-base font-semibold text-gray-900">
                                    $<?php echo e(number_format($s->total_asignado, 2)); ?>

                                </div>
                            </div>
                        </div>
                        <div class="mt-3 flex items-center justify-end gap-2">
                            <a href="<?php echo e(route('admin.solicitudes.show', $s->id)); ?>"
                            ...
                            <a href="<?php echo e(route('admin.solicitudes.pdf', $s->id)); ?>" target="_blank"
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $solicitudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/80">
                                <td class="px-4 py-3">
                                    <?php echo e($loop->iteration + (($solicitudes->firstItem() ?? 1) - 1)); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <?php echo e($s->centro_universitario); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-900"><?php echo e($s->nombre_coordinador); ?></div>
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <?php if(isset($s->estado)): ?>
                                        <span class="inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium
                                                    <?php echo e($s->estado==='validado' ? 'bg-emerald-50 text-emerald-700 ring-emerald-200' :
        ...
        <div class="mt-5 flex flex-col items-center justify-between gap-3 sm:flex-row">
            <div class="text-sm text-gray-600">
                Mostrando
                <span class="font-semibold"><?php echo e($solicitudes->firstItem() ?? 0); ?></span>
                a
                <span class="font-semibold"><?php echo e($solicitudes->lastItem() ?? 0); ?></span>
                de
                <span class="font-semibold"><?php echo e($solicitudes->total()); ?></span>
                registros
            </div>
            <div>
                <?php echo e($solicitudes->onEachSide(1)->links('vendor.pagination.pretty')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/solicitudes/index.blade.php ENDPATH**/ ?>