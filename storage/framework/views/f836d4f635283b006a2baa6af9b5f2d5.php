...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-20 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a href="<?php echo e(route('admin.convocatorias.create')); ?>"
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <?php if(session('success') || session('warning') || session('danger') || session('error') || session('status')): ?>
                <?php
            ...
            <div class="mb-4 rounded-xl border bg-white p-4">
                <form method="GET" action="<?php echo e(route('admin.convocatorias.index')); ?>" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span class="font-semibold"><?php echo e($convocatorias->firstItem() ?? 0); ?>–<?php echo e($convocatorias->lastItem() ?? 0); ?></span>
                        <span class="hidden sm:inline">de</span>
                        <span class="font-semibold"><?php echo e($convocatorias->total()); ?></span>
            ...
            <div class="overflow-x-auto rounded-xl border bg-white">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $convocatorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/80">
                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-900"><?php echo e($c->nombre_convocatoria); ?></div>
                                    <div class="text-xs text-gray-500">Creada: <?php echo e($c->created_at?->format('d/m/Y')); ?></div>
                                </td>
                                <td class="px-4 py-3 text-gray-700"><?php echo e($c->lema ?? '—'); ?></td>
                                <td class="px-4 py-3 text-gray-700">
                                    <div><?php echo e($c->responsable ?? '—'); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($c->cargo ?? ''); ?></div>
                                </td>
                                <td class="px-4 py-3 text-gray-700">
                                    <?php
                                    ...
                                    ?>
                                    <?php echo e($fi); ?> – <?php echo e($ff); ?>

                                </td>
                                <td class="px-4 py-3"><?php echo e($c->anio); ?></td>
                                <td class="px-4 py-3">
                                    <?php if($c->id_status): ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1.5">
                                        <a href="<?php echo e(route('admin.convocatorias.show', $c)); ?>"
                                           title="Ver"
                                        ...
                                        <a href="<?php echo e(route('admin.convocatorias.edit', $c)); ?>"
                                           title="Editar"
                                            ...
                                            <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
                                                ...
                                                <div class="relative w-full max-w-sm rounded-xl bg-white p-5 shadow-lg">
                                                    ...
                                                    <p class="mb-4 text-sm text-gray-600">
                                                        ¿Deseas eliminar la convocatoria <span class="font-medium"><?php echo e($c->nombre_convocatoria); ?></span>?
                                                    </p>
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        <form action="<?php echo e(route('admin.convocatorias.destroy', $c)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
            ...
            <div class="mt-4 flex flex-col items-center justify-between gap-2 sm:flex-row">
                <div class="text-sm text-gray-600">
                    Mostrando
                    <span class="font-semibold"><?php echo e($convocatorias->firstItem() ?? 0); ?></span>
                    a
                    <span class="font-semibold"><?php echo e($convocatorias->lastItem() ?? 0); ?></span>
                    de
                    <span class="font-semibold"><?php echo e($convocatorias->total()); ?></span>
                    registros
                </div>
                <div>
                    <?php echo e($convocatorias->onEachSide(1)->links('vendor.pagination.pretty')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/convocatorias/index.blade.php ENDPATH**/ ?>