            ...
            <div class="flex items-center justify-between rounded-2xl border bg-white px-5 py-4 shadow-sm">
                <div class="flex items-center gap-4">
                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-indigo-100 text-indigo-700">
                        <span class="text-sm font-semibold"><?php echo e($centro->siglas); ?></span>
                    </div>
                    <div>
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <section class="rounded-2xl border bg-white p-5 shadow-sm">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($centro->nombre_rector ?: '—'); ?></p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->telefonos ?: '—'); ?></p>
                        </div>

                        <div>
                            <p class="text-xs uppercase tracking-wide text-gray-500">Sitio web</p>
                            <p class="mt-1 text-sm">
                                <?php if($centro->sitio_web): ?>
                                    <a href="<?php echo e($centro->sitio_web); ?>" target="_blank" rel="noopener"
                                       class="text-indigo-600 hover:text-indigo-800 underline decoration-dotted underline-offset-2">
                                        <?php echo e($centro->sitio_web); ?>
                ...
                <section class="rounded-2xl border bg-white p-5 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div class="rounded-xl border bg-gray-50 px-4 py-3">
                            ...
                            <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->direccion ?: '—'); ?></p>
                        </div>

                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div class="rounded-xl border bg-gray-50 px-4 py-3">
                                <p class="text-[11px] font-semibold tracking-wider text-gray-500">COLONIA</p>
                                <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->colonia ?: '—'); ?></p>
                            </div>
                            <div class="rounded-xl border bg-gray-50 px-4 py-3">
                                <p class="text-[11px] font-semibold tracking-wider text-gray-500">CÓDIGO POSTAL</p>
                                <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->codigo_postal ?: '—'); ?></p>
                            </div>
                            <div class="rounded-xl border bg-gray-50 px-4 py-3">
                                <p class="text-[11px] font-semibold tracking-wider text-gray-500">MUNICIPIO</p>
                                <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->municipio ?: '—'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div class="rounded-xl border bg-gray-50 px-4 py-3">
                                ...
                                <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->estado ?: '—'); ?></p>
                            </div>
                            <div class="rounded-xl border bg-gray-50 px-4 py-3">
                                <p class="text-[11px] font-semibold tracking-wider text-gray-500">PAÍS</p>
                                <p class="mt-1 text-sm text-gray-800"><?php echo e($centro->pais ?: '—'); ?></p>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <section class="rounded-2xl border bg-white p-5 shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div class="rounded-xl border bg-gray-50 px-4 py-3">
                        ...
                        <p class="mt-1 text-sm text-gray-800"><?php echo e(optional($centro->created_at)->format('d/m/Y H:i') ?? '—'); ?></p>
                    </div>
                    <div class="rounded-xl border bg-gray-50 px-4 py-3">
                        <p class="text-[11px] font-semibold tracking-wider text-gray-500">ACTUALIZADO EL</p>
                        <p class="mt-1 text-sm text-gray-800"><?php echo e(optional($centro->updated_at)->format('d/m/Y H:i') ?? '—'); ?></p>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/centros/show.blade.php ENDPATH**/ ?>