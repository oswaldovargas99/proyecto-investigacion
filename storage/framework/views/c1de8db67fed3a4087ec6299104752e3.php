    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="mb-4 rounded-xl border bg-white p-4">
                <form method="GET" action="<?php echo e(route('admin.usuarios.index')); ?>" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span class="font-semibold"><?php echo e($users->firstItem() ?? 0); ?>–<?php echo e($users->lastItem() ?? 0); ?></span>
                        <span class="hidden sm:inline">de</span>
                        <span class="font-semibold"><?php echo e($users->total()); ?></span>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/80">
                                <td class="px-4 py-3">
                                    <?php echo e($users->firstItem() ? $loop->iteration + ($users->firstItem() - 1) : $loop->iteration); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-900"><?php echo e($usuario->name); ?></div>
                                    <div class="text-xs text-gray-500">ID: <?php echo e($usuario->id); ?></div>
                                </td>
                                <td class="px-4 py-3">
                                    <a href="mailto:<?php echo e($usuario->email); ?>"
                                ...
                                <td class="px-4 py-3">
                                    <span class="inline-flex items-center rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-200">
                                        <?php echo e($roles[$usuario->role] ?? $usuario->role); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1.5">
                                        <a href="<?php echo e(route('admin.usuarios.show', $usuario)); ?>"
                                           title="Ver"
                                            ...
                                            <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
                                                ...
                                                <div class="relative w-full max-w-sm rounded-xl bg-white p-5 shadow-lg">
                                                    ...
                                                    <p class="mb-4 text-sm text-gray-600">
                                                        ¿Deseas eliminar al usuario <span class="font-medium"><?php echo e($usuario->name); ?></span>?
                                                    </p>
            ...
            <div class="mt-4 flex flex-col items-center justify-between gap-2 sm:flex-row">
                <div class="text-sm text-gray-600">
                    Mostrando
                    <span class="font-semibold"><?php echo e($users->firstItem() ?? 0); ?></span>
                    a
                    <span class="font-semibold"><?php echo e($users->lastItem() ?? 0); ?></span>
                    de
                    <span class="font-semibold"><?php echo e($users->total()); ?></span>
                    registros
                </div>
                <div>
                    <?php echo e($users->onEachSide(1)->links('vendor.pagination.pretty')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-pfp_b\resources\views/administrador/usuarios/index.blade.php ENDPATH**/ ?>